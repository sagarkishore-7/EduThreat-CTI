...
CREATE INDEX IF NOT EXISTS idx_campaigns_status_confidence
    ON campaigns (status, confidence DESC);
...
CREATE INDEX IF NOT EXISTS idx_campaign_memberships_campaign
    ON campaign_memberships (campaign_id);
CREATE INDEX IF NOT EXISTS idx_campaign_memberships_canonical
    ON campaign_memberships (canonical_incident_id);
CREATE INDEX IF NOT EXISTS idx_campaign_memberships_review
    ON campaign_memberships (review_status);
...
CREATE INDEX IF NOT EXISTS idx_campaign_evidence_campaign
    ON campaign_evidence_items (campaign_id);
CREATE INDEX IF NOT EXISTS idx_campaign_evidence_canonical
    ON campaign_evidence_items (canonical_incident_id);
...
CREATE INDEX IF NOT EXISTS idx_campaign_signatures_campaign
    ON campaign_signatures (campaign_id);
